...
<br><br><br><br>
    ...
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="employees_new.php" class="btn btn-success">Create</a>
                </p>
                ...
                <table class="table table-striped table-bordered">
                      ...
                      <?php
                       ...
                       $sql = 'SELECT * FROM employees ORDER BY employees_id ASC';
                       foreach ($conn->query($sql) as $row) {
                                echo '<tr>';
								echo '<td>'. $row['employees_id'] .'.'. '</td>';
                                echo '<td>'. $row['employees_name'] . '</td>';
                                echo '<td>'. $row['employees_age'] . '</td>';
                                echo '<td>'. $row['employees_occupation'] . '</td>';
								echo '<td>'. $row['employees_hourly_rate'] . '</td>';
								echo '<td>'. $row['society_id'] . '</td>';
                                echo '<td width=200>';
                                echo '<a class="btn btn-secondary" href="employees_update.php?employees_id='.$row['employees_id'].'">Update</a>';
                                echo ' ';
                                echo '<a class="btn btn-danger" href="employees_delete.php?employees_id='.$row['employees_id'].'">Delete</a>';
								echo ' ';
                                echo '</td>';
                                echo '</tr>';
                       }
