...
{	
    $edit = mysqli_query($conn,"delete from employees where employees_id = '$id'");
...
<div class="signup-form">
    ...
    <form  method="post">
		<h2>Delete a Tower</h2>
		<p>Are you sure you want to delete the Employee: <?php echo $data['employees_name'] ?> </p>
		<hr>
