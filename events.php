...
<br><br><br><br>
    ...
    <div class="container">
            <div class="row">
                <h3>Events for the society</h3>
            </div>
			<br>
            <div class="row">
                <p>
                    <a href="events_new.php" class="btn btn-success">Create</a>
                </p>
                ...
                <table class="table table-striped table-bordered">
                      ...
                      <?php
                       ...
                       foreach ($conn->query($sql) as $row) {
                                ...
                                echo '<td width=200>';
                                echo '<a class="btn btn-success" href="events_update.php?id='.$row['event_id'].'">Update</a>';
                                echo ' ';
                                echo '<a class="btn btn-danger" href="events_delete.php?id='.$row['event_id'].'">Delete</a>';
