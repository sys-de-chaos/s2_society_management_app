...
<br><br><br><br>
    ...
    <div class="container">
            <div class="row">
                <h3>Tennats in your society</h3>
            </div>
			<br>
            <div class="row">
                <p>
                    <a href="owners_new.php" class="btn btn-success">Create</a>
                </p>
                ...
                <table class="table table-striped table-bordered">
                      ...
                      <?php
                       ...
                       $sql = 'SELECT * FROM tennants ORDER BY tennants_id ASC';
                       foreach ($conn->query($sql) as $row) {
                                echo '<tr>';
								echo '<td>'. $row['tennants_id'] .'.'. '</td>';
                                echo '<td>'. $row['tennants_name'] . '</td>';
                                echo '<td>'. $row['tennants_address'] . '</td>';
   								echo '<td>'. $row['tennants_gender'] . '</td>';
								echo '<td>'. $row['tennant_purchase_date'] . '</td>';
                                echo '<td width=200>';
                                echo '<a class="btn btn-success" href="owners_update.php?id='.$row['tennants_id'].'">Update</a>';
                                echo ' ';
                                echo '<a class="btn btn-danger" href="owners_delete.php?id='.$row['tennants_id'].'">Delete</a>';
                                echo '</td>';
                                echo '</tr>';
                       }
