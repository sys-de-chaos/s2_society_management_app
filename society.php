    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="active" href="society.php">Society</a>
...
<br><br><br><br>
    ...
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="society_new.php" class="btn btn-success">Create</a>
                </p>
                ...
                <table class="table table-striped table-bordered">
                      ...
                      <?php
                       ...
                       $sql = 'SELECT * FROM society ORDER BY society_id ASC';
                       foreach ($conn->query($sql) as $row) {
                                echo '<tr>';
								echo '<td>'. $row['society_id'] .'.'. '</td>';
                                echo '<td>'. $row['society_name'] . '</td>';
                                echo '<td>'. $row['society_address'] . '</td>';
                                echo '<td>'. $row['society_manager'] . '</td>';
								echo '<td>'. $row['society_population'] . '</td>';
								echo '<td>'. $row['society_facilities'] . '</td>';
                                echo '<td width=265>';
                                echo '<a class="btn btn-secondary" href="society_update.php?society_id='.$row['society_id'].'">Update</a>';
                                echo ' ';
                                echo '<a class="btn btn-danger" href="society_delete.php?society_id='.$row['society_id'].'">Delete</a>';
								echo ' ';
								echo '<a class="btn btn-warning" href="towers.php?society_id='.$row['society_id'].'">Towers</a>';
                                echo '</td>';
                                echo '</tr>';
                       }
