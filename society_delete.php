...
{	
    $edit = mysqli_query($conn,"delete from society where society_id = '$id'");
...
<div class="signup-form">
    ...
    <form  method="post">
		<h2>Delete a Society</h2>
		<p>Are you sure you want to delete the society: <?php echo $data['society_name'] ?> </p>
		<hr>
