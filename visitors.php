...
<br><br><br><br>
    ...
    <div class="container">
            <div class="row">
                <h3>Visitors to the society</h3>
            </div>
			<br>
            <div class="row">
                <p>
                    <a href="visitors_new.php" class="btn btn-success">Create</a>
                </p>
            <br>    
                <table class="table table-striped table-bordered">
                      ...
                      <?php
                       ...
                       foreach ($conn->query($sql) as $row) {
                                ...
                                echo '<td>'. $row['visitor_destination'] . '</td>';
								echo '<td>'. $row['visitor_reason'] . '</td>';
								echo '<td>'. $row['visitor_in_date'] . '</td>';
								echo '<td>'. $row['visitor_out_date'] . '</td>';
                                echo '<td width=150>';
                                echo '<a class="btn btn-success" href="visitors_update.php?id='.$row['visitor_id'].'">Update</a>';
                                echo ' ';
                                echo '</td>';
                                echo '</tr>';
                       }
